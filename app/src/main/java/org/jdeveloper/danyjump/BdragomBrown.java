...
public class BdragomBrown extends GameObject {
    ...
    BdragomBrown(Context context, float worldStartX, float worldStartY, char type, int pixelsPerMetre){

        final int ANIMATION_FPS=8;
        final int ANIMATION_FRAME_COUNT=8;
        final String BITMAP_NAME="bdragombrown";

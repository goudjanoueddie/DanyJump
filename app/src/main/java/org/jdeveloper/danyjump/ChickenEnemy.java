...
public class ChickenEnemy extends GameObject {
    ...
    ChickenEnemy(Context context,float worldStartX,float worldStartY,char type,int pixelsPerMetre){

        final int ANIMATION_FPS=4;
        final int ANIMATION_FRAME_COUNT=4;
        //final String BITMAP_NAME="chicken";
        final String BITMAP_NAME="sleepingdog";

...
public class DogEnemyBrun extends GameObject {
    ...
    DogEnemyBrun(Context context, float worldStartX, float worldStartY, char type, int pixelsPerMetre){

        final int ANIMATION_FPS=8;
        final int ANIMATION_FRAME_COUNT=4;
        final String BITMAP_NAME="dogenemybrun";

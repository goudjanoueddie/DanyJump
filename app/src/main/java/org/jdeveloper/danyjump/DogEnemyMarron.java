...
public class DogEnemyMarron extends GameObject {
    ...
    DogEnemyMarron(Context context, float worldStartX, float worldStartY, char type, int pixelsPerMetre){

        final int ANIMATION_FPS=8;
        final int ANIMATION_FRAME_COUNT=3;
        final String BITMAP_NAME="dogenemymarron";

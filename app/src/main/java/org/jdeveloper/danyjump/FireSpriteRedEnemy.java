...
public class FireSpriteRedEnemy extends GameObject {
    ...
    FireSpriteRedEnemy(Context context, float worldStartX, float worldStartY, char type, int pixelsPerMetre){

        final int ANIMATION_FPS=8;
        final int ANIMATION_FRAME_COUNT=1;
        final String BITMAP_NAME="firespritered";

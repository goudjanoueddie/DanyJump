                ...
                if (!vp.clipObjects(go.getWorldLocation().x, go.getWorldLocation().y, go.getWidth(), go.getHeight())) {
                    ...
                    for (int i=0;i<lm.player.bfg.getNumBullets();i++) {
                        ...
                        if (go.getHitbox().intersects(r)) {
                            ...
                            if (go.getType() != 'g' && go.getType() != 'd' && go.getType() != 'b' && go.getType() != 'j' && go.getType() != 'o' && go.getType() != 'k' && go.getType()!='n' && go.getType()!='+' && go.getType()!='@' && go.getType()!='O' && go.getType()!='M' && go.getType() !='D' && go.getType()!='a' && go.getType() !='R' && go.getType() !='B' && go.getType()!='I' && go.getType()!='G' && go.getType()!='T' && go.getType()!='*' && go.getType() !='θ' && go.getType() !='η') {//if it is different of enemy
